...
const routes: Routes = [
    ...
    {path: 'admin/drivers/profile/:id', component: ProfileDriverComponent, data: {title: 'wowTow Employer Driver profile'}},
    {path: 'admin/customers', component: CustomersComponent, data: {title: 'Customers'}},
    {path: 'admin/customers/profile/:id', component: ProfileComponent, data: {title: 'Customer Profile'}},
